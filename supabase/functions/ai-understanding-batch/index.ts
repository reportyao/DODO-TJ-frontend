...
7. recommended_badge 必须是2-4个词的短角标，只描述商品功能/特性/人群，绝对禁止出现任何数字、价格、货币单位（сомони、TJS等）。正确示例："Барои кӯдакон"、"Тӯҳфаи беҳтарин"。错误示例（绝对不要）："Хит за 5 сомони"、"5 сомони специально"。
8. 只输出 JSON，不要附加说明。
